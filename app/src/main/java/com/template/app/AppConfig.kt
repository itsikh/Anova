...
object AppConfig {
    ...
    /**
     * Notification channel ID used by [notifications.AnovaAlertManager] to post
     * temperature threshold alerts. Must match the channel created in [TemplateApplication.onCreate].
     */
